...
const ACOES = {
  ...
  modulos:      { criar: ["Admin", "Coordenador", "Professor"], editar: ["Admin", "Coordenador"],           excluir: ["Admin"]                   },
  ...
  conteudos:    { criar: ["Admin", "Professor"],              editar: ["Admin", "Professor"],             excluir: ["Admin", "Professor"]      },
